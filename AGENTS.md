...
| `bash tools/verify-module-availability-report.sh` | Guards `docs/verification/module-availability-verification.md` coverage: required sections, core modules, all `SettingsAction` entries, real WebView JSBridge evidence, Debug Center concrete-screen/content/action evidence, shanbox fixture evidence, and known unavailable markers | `96 passed, 0 failed` | Run after changing Settings navigation, module IA, availability docs, public fixture checks, or known unavailable status |
